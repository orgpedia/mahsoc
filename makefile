...
import/websites/gr.maharashtra.gov.in/SocialJustice:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/SocialJustice .
...
import: check_env import/websites/gr.maharashtra.gov.in/SocialJustice .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/SocialJustice import/documents
